...
const testTasksData: Task[] = [
  {
    ...
    taskFiles: [
      "10-10-24_02:36:39_CSV_Data.csv",
      "10-10-24_02:36:39_CSV_Data.csv",
    ],
...
export const TasksPage = (): JSX.Element => {
  ...
  const [isOpenCreateResponseModal, setIsOpenCreateResponseModal] =
    useState<boolean>(false);

  const [newTaskResponseForm] = Form.useForm<{
    responseFiles: UploadFile[];
    commentText: string;
  }>();
    ...
    },
    {
      ...
      render: (_, record) => (
        <Flex justify="center" align="center" vertical>
          ...
          record.status === TaskStatus.REWORK ? (
            <Button
              type="link"
              onClick={() => {
                setSelectedTask(record);
            ...
            {selectedTask ? (
              <Flex vertical gap={10}>
                ...
                <Paragraph>
                  ...
                  {selectedTask.type === TaskType.ESSAY ? "Эссе" : "Рецензия"}
                </Paragraph>
                <Paragraph>
                ...
                <FileList
                  files={selectedTask.taskFiles ? selectedTask.taskFiles : []}
                />
                <Paragraph>
          ...
          <Modal
            ...
            onOk={() => {
              if (selectedTask) {
                ...
                const responseFiles = newTaskResponse.responseFiles?.length
                  ? newTaskResponse.responseFiles.map(
                      (uploadFile) => uploadFile.originFileObj as File
                    )
                  : [];
                ...
                httpClient
                  .axios()
                  .post(
                    config.endPoints.addResponseTask.replace(
                      "{taskId}",
                  ...
                  .then((response) => {
                    ...
                    setIsOpenCreateResponseModal(false);
                    newTaskResponseForm.resetFields([
                      "responseFiles",
                      "commentText",
                    ]);
            ...
            width={800}
          >
            <Form form={newTaskResponseForm} layout="vertical">
                  ...
                  init={{
                    ...
                    menu: {
                      ...
                      view: {
                        title: "View",
                        items:
                          "visualblocks | spellchecker | preview fullscreen",
                      },
                      insert: {
                        title: "Insert",
