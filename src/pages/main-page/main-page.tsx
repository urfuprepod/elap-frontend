...
export const MainPage = (): JSX.Element => {
    const [lastAdvertisementsData, setLastAdvertisementsData] = useState<
        Advertisement[]
    >([]);
    ...
    useEffect(() => {
        httpClient
            .axios()
            .get<Advertisement[]>(config.endPoints.getLastAdvertisementsUrl)
            .then((response) => {
        ...
        httpClient
            .axios()
            .get<FaqItem[]>(config.endPoints.getAllFaqItems)
            .then((response) => {
            ...
            lastAdvertisementsData.forEach((item) => {
                result.push(
                    <Col
                        ...
                        lg={24}
                        xl={
                            lastAdvertisementsData.length === 1
                                ? 24
                                : lastAdvertisementsData.length === 2
                                ? 12
                                : 8
                        }
                        xxl={
                    ...
                    >
                        ...
                        >
                            ...
                            {item?.files?.length ? (
                                <FileList link="main" files={item.files} />
                            ) : null}
                            <Flex
    ...
    return (
        <div className="main-page">
            <div className="hero-section">
                <Row>
                    <Col
                        ...
                        className="hero-text"
                    >
                        <Flex justify="center" align="start" vertical gap={15}>
                            <div>
            ...
            <Section
                title="Объявления"
                additionalUrl="/advertisements"
                additionalText="Посмотреть все"
            >
