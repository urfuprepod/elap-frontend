...
const user = JSON.parse(localStorage.getItem("elap:portal:user") ?? "{}");
    ...
    const getAccountByRole = (): JSX.Element => {
        if (authContext) {
            if (
                    ...
                    <>
                        ...
                        >
                            <Form
                                ...
                                layout="vertical"
                            >
                                <Form.Item label="Логин:" labelAlign="left">
                                    <Input
                                        value={user?.login ?? ''}
                                        disabled
                                        style={{
                                ...
                                <Form.Item label="Роль:" labelAlign="left">
                                    <Input
                                        value="Администратор"
                                        disabled
                ...
                authContext.userInfo.authorities?.filter(
                    (authorityInfo) =>
                        authorityInfo.authority === UserAuthorityType.MENTOR
                ).length
            ) {
                return (
                    <>
                        ...
                        >
                            ...
                            >
                                <Form.Item label="Логин:" labelAlign="left">
                                    <Input
                                        value={authContext.userInfo.login}
                                        disabled
                                        style={{
                                            borderRadius: "32px",
                                            minWidth: "300px",
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <Input
                                        value={
                                            authContext.userInfo.mentor?.login
                                        }
                                        disabled
                                        style={{ borderRadius: "32px" }}
                                    />
                        ...
                        onOk={() => {
                            changePasswordForm
                                ...
                                .then((fields) => {
                                    httpClient
                                        .axios()
                                        .post(config.endPoints.changePassword, {
