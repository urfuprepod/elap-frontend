...
export const AdvertisementsPage = (): JSX.Element => {
    ...
    const [isOpenCreateAdvertisementModal, setIsOpenCreateAdvertisementModal] =
        useState<boolean>(false);
    const [isOpenEditAdvertisementModal, setIsOpenEditAdvertisementModal] =
        useState<boolean>(false);
    const [isOpenDeleteAdvertisementModal, setIsOpenDeleteAdvertisementModal] =
        useState<boolean>(false);
    const [selectedAdvertisementFileList, setSelectedAdvertisementFileList] =
        useState<UploadFile[]>([]);

    const [createAdvertisementForm] = Form.useForm<{
        title: string;
        text: string;
        filesList: UploadFile[];
    }>();
    const [editAdvertisementForm] = Form.useForm<{
        title: string;
        text: string;
        filesList: UploadFile[];
    }>();
    ...
    const updateAdvertisementsData = () => {
        httpClient
            .axios()
            .get<Advertisement[]>(config.endPoints.getAllAdvertisementsUrl)
            .then((response) => {
                                ...
                                {authContext?.userInfo.authorities?.filter(
                                    ...
                                    <Flex>
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                setSelectedAdvertisementFileList(
                                                    getUploadFiles(item.files)
                                                );
                                                setIsOpenEditAdvertisementModal(
                                                    true
                                                );
                                            }}
                                        />
                                        <Button
                                            ...
                                            onClick={() => {
                                                setSelectedAdvertisement(item);
                                                setIsOpenDeleteAdvertisementModal(
                                                    true
                                                );
                                            }}
                                        />
    ...
    return (
        <div className="advertisements-page">
            <Section title="Объявления" className="content">
                {authContext?.userInfo.authorities?.filter(
                    (authorityInfo) =>
                        authorityInfo.authority === UserAuthorityType.ADMIN
                ).length ? (
                    <>
                        <Button
                            ...
                            icon={<IconPlus />}
                            onClick={() => {
                                setIsOpenCreateAdvertisementModal(true);
                            }}
                        >
                            Добавить объявление
                        </Button>
                        ...
                        <Modal
                            ...
                            onCancel={() => {
                                ...
                                createAdvertisementForm.resetFields([
                                    "title",
                                    "text",
                                    "filesList",
                                ]);
                            ...
                            onOk={() => {
                                createAdvertisementForm
                                    .validateFields()
                                    .then((fields) => {
                                        const advertisementFiles = fields
                                            .filesList?.length
                                            ? fields.filesList.map(
                                                  (uploadFile) =>
                                        ...
                                        httpClient
                                            ...
                                            .then(() => {
                                                ...
                                                setIsOpenCreateAdvertisementModal(
                                                    false
                                                );
                                                createAdvertisementForm.resetFields(
                                                    [
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        ...
                                        },
                                        {
                                            ...
                                            message:
                                                "Заголовок: неверный формат поля!",
                                        },
                                    ]}
                                >
                                    <Input
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        ...
                                        },
                                        {
                                            ...
                                            min: 10,
                                            message:
                                                "Текст: длина должна быть больше или равна 10 символам!",
                                        },
                                    ]}
                                >
                                    <TextArea
                        ...
                        <Modal
                            ...
                            onCancel={() => {
                                ...
                                setSelectedAdvertisementFileList([]);
                                editAdvertisementForm.resetFields([
                                    "title",
                                    "text",
                                    "filesList",
                                ]);
                                ...
                                editAdvertisementForm
                                    ...
                                    .then((fields) => {
                                        ...
                                        appendFilesToFormData(
                                            "files",
                                            formData,
                                            selectedAdvertisementFileList
                                        );
                                        httpClient
                                            .axios()
                                            .put(
                                                config.endPoints.editAdvertisement.replace(
                                                    "{advertisementId}",
                                                    selectedAdvertisement?.id.toString() as string
                                                ),
                                                formData
                                            )
                                            .then(() => {
                        ...
                        >
                            ...
                            >
                                <Form.Item
                                    ...
                                    label="Заголовок:"
                                    required
                                    initialValue={selectedAdvertisement?.title}
                                    rules={[
                                        {
                                            required: true,
                                            message:
                                ...
                                <Form.Item
                                    ...
                                    label="Текст:"
                                    required
                                    initialValue={selectedAdvertisement?.text}
                                    rules={[
                                        {
                                            required: true,
                                            message:
                        ...
                        <Modal
                            ...
                            onOk={() => {
                                httpClient
                                    .axios()
                                    .delete(
                                        config.endPoints.deleteAdvertisement.replace(
                                            "{advertisementId}",
                                            selectedAdvertisement?.id.toString() as string
                                        )
                                    )
                ...
                <Row gutter={[16, 16]}>{getAdvertisements()}</Row>
            </Section>
        </div>
    );
};
